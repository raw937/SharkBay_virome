...
tax_l <- read.delim("taxonomy_ssDNA-family_down_metavir2_compare-others_norm_bar.txt")
...
t1 <- t1 + labs(title="", x="Refseq taxonomy", y="Relative Abundance", fill="Viral Classification")
